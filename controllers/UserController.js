...
//     if (req.body.whatsapp_number) {
//       orConditions.push({ whatsapp_number: req.body.whatsapp_number });
//     }
...
//     trackChange("name", user.name, req.body.name);
//     trackChange("email", user.email, req.body.email);
//     trackChange("phone", user.phone_number, req.body.phone_number);
//     trackChange("whatsapp", user.whatsapp_number, req.body.whatsapp_number);
//     trackChange("city", user.city, req.body.city);
...
//       success: true,
//       message: "User updated successfully",
//       changes, // 🔥 history output (optional UI use)
//     });
